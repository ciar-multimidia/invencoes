var dadosLivros = [
...

	{
		...
		"capitulos": [
			{
				"titulo":"Como duas metáforas podem ajudar-nos na compreensão do fenômeno de comunicação da escrita hipermidiatizada?",
				"autores": ["Andrea Rodríguez Mancera"]
			},

			{
				"titulo":"O Tesouro de Pitfall, da empresa Kellogg’s: para uma sociedade em jogo(s)",
				"autores": ["Aurora Burca"]
			},

			{
				"titulo":"Processo de criação e desenvolvimento de games pela empresa francesa Swing Swing Submarine. Relato de produção",
				"autores": ["Guillaume Martin"]
			},

			{
				"titulo":"Real – virtual: fusão ou confusão?",
				"autores": ["François-Gabriel Roussel"]
			},

			{
				"titulo":"Novo quadro de transmissão de conhecimentos baseado em análise de modelos empíricos em Ciências da Informação e da Comunicação e em Ciências da Gestão",
				"autores": ["Naoil Chaouni"]
			},

			{
				"titulo":"Da utilização das TICs nas políticas de saúde pública: abordagem comparativa entre a França e o Brasil",
				"autores": ["Nathalie Verdier", "Vanderlei Cassiano"]
			},

			{
				"titulo":"McDonald’s: símbolo da mundialização na Copa do Mundo 2014 no Brasil",
				"autores": ["Mihai Crangasu"]
			},

			{
				"titulo":"A aprendizagem e a participação social dos jovens adultos por meio do uso de dispositivos digitais na Web",
				"autores": ["Diana Giraldo"]
			}
		]
	},
		...
		"capitulos": [
			{
				...
				"categoria": "Os Jovens e as Redes"
			},
